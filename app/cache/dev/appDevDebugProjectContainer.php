...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'akademi', 'user' => 'root', 'password' => 'kalkandere', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/CagatayBundle/Entity'), 1 => ($this->targetDirs[3].'/src/DenemeBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'CagatayBundle\\Entity');
        $c->addDriver($b, 'DenemeBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('CagatayBundle' => 'CagatayBundle\\Entity', 'DenemeBundle' => 'DenemeBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_2ad8ad251174a5e35698b59c64047fb878cceeefb933987c0f9132ec1bc43743');
    ...
    {
        return $this->services['templating.asset.default_package.http'] = new \Symfony\Component\Templating\Asset\UrlPackage(array(0 => 'http://localhost/akademi/web/assets/'), NULL, '%s?%s');
    }
     ...
     * 
     * @throws InactiveScopeException when the 'templating.asset.default_package.ssl' service is requested while the 'request' scope is not active
     */
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/CagatayBundle/Resources/views'), 'Cagatay');
        $instance->addPath(($this->targetDirs[3].'/src/DenemeBundle/Resources/views'), 'Deneme');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'CagatayBundle' => 'CagatayBundle\\CagatayBundle',
                'DenemeBundle' => 'DenemeBundle\\DenemeBundle',
            ...
            'site_url' => 'http://localhost/akademi',
